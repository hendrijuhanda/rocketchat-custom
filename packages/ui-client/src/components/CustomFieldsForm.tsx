...
import type { Control, FieldError as RHFFieldError, FieldValues } from 'react-hook-form';
...
const CustomField = <T extends FieldValues>({
	...
	const validateRequired = useCallback((value: unknown) => (required ? typeof value === 'string' && !!value.trim() : true), [required]);
